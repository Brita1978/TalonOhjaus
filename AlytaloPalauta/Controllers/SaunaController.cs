...
namespace AlytaloPalauta.Controllers
{
    public class SaunaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SaunaID,SaunanSijainti,SaunaPaalla,SaunanLampotila,PVM")] Saunat saunat)
        {
            if (ModelState.IsValid)
            {
                db.Saunat.Add(saunat);
                saunat.PVM = DateTime.Now;
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SaunaID,SaunanSijainti,SaunaPaalla,SaunanLampotila,PVM")] Saunat saunat)
        {
            if (ModelState.IsValid)
            {
